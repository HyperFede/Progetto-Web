...
router.post('/process', async (req, res) => {
    ...
    res.send(`POST /api/payments/process - Elabora pagamento per l'ordine ${orderId}`); // Messaggio di placeholder
});
...
router.post('/webhook', (req, res) => {
    ...
    res.send('POST /api/payments/webhook - Webhook di pagamento ricevuto'); // Messaggio di placeholder
});
